...
AT.do_extract_models_single_rmf(HA, 
    ...
    scores_prefix = "A_gsm_clust"+str(c))  # Prefix for the scores file

AT.do_extract_models_single_rmf(HB, rmf_file_out_B, top_dir, analys_dir, scores_prefix = "B_gsm_clust"+str(c))
