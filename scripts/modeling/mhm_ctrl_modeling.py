...
global_output_dir = 'run_' + str(runID)

if not os.path.isdir(global_output_dir): # Check if output_dir is present. If not make it
...
# Identify data files
adh_xl_data = "../../input/mhm_ctrl/xlms/filtered_out_adh_master.dat"
bs3dss_xl_data = "../../input/mhm_ctrl/xlms/filtered_out_bs3dss_master.dat"
dmtmm_xl_data = "../../input/mhm_ctrl/xlms/filtered_out_dmtmm_master.dat"
gmm_data = "../../input/mhm_ctrl/gmm/emd_21382.gmm.90.txt"
...
# Topology File
topology_file = "../../input/mhm_ctrl/topology.txt"
...
rex=IMP.pmi.macros.ReplicaExchange0(mdl,
	...
	monte_carlo_sample_objects=dof.get_movers(),  # pass all objects to be moved ( almost always dof.get_movers() )
        global_output_directory=global_output_dir,    # The output directory for this sampling run.
