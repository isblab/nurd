...
runID = sys.argv[2] # Specify the run number
...
adh_xl_data = "../../input/mhr_ctrl/xlms/mhr_adh_xl.dat"
bs3dss_xl_data = "../../input/mhr_ctrl/xlms/mhr_bs3dss_xl.dat"
dmtmm_xl_data = "../../input/mhr_ctrl/xlms/mhr_dmtmm_xl.dat"
...
# Topology File
topology_file = "../../input/mhr_ctrl/topology.txt"
...
root_hier, dof = bs.execute_macro(max_rb_trans= 1.2,
                                  max_rb_rot= 0.1,
                                  max_bead_trans= 4.0,
                                  max_srb_trans= 0.2,
                                  max_srb_rot=0.1)
